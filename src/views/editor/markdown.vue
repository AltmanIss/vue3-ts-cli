<template>
  <div class="main-container">
    ...
    <div class="margin-top-lg">
      <el-button size="small" @click="addText">增加文本</el-button>
      <el-button size="small" @click="addImage">增加图片</el-button>
      <el-button size="small" type="primary" @click="getHTML">预览HTML</el-button>
    </div>
    <div
      v-if="priviewContent"
...
function getHTML() {
  priviewContent.value = (SimpleMDE.prototype as any).markdown(editorText.value);
}
</script>
