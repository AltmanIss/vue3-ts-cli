      ...
      <template #content>
        ...
        >
          ...
          <el-form-item label="菜单地址" prop="path">
            <el-input v-model="menuModel.path" size="small" placeholder="请输入菜单地址">
            </el-input>
          </el-form-item>
          <el-form-item label="外链地址">
            <el-input v-model="menuModel.outLink" size="small" placeholder="请输入外链地址">
            </el-input>
          </el-form-item>
...
function onUpdateItem(item: any) {
  ...
  dialogRef.value?.show(() => {
    ElMessageBox.confirm('模拟数据修改成功，参数为：' + JSON.stringify(menuModel));
    dialogRef.value?.close();
  });
}
