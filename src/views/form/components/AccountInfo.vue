  ...
  <div>
    ...
    >
      <el-form-item label="付款账户：">
        <el-select v-model="accountInfo.account" placeholder="请输入付款账户" style="width: 100%">
          <el-option label="vue-admin-work@work.com" :value="accountInfo.account" />
        </el-select>
      </el-form-item>
      <el-form-item label="收款账户：" prop="otherAccount">
        <el-input
        ...
        >
          <template #prepend>
            <el-select v-model="accountInfo.type" placeholder="请选择" style="width: 110px">
              <el-option
      ...
      <el-form-item label="收款人姓名：" prop="receiveName">
        <el-input v-model="accountInfo.receiveName" placeholder="请输入收款人姓名" />
      </el-form-item>
      <el-form-item label="转账金额：" prop="money">
        <el-input v-model="accountInfo.money" placeholder="请输入转账金额">
      ...
      <el-form-item class="flex justify-end margin-tb">
        <el-button size="small" @click="clearStepOneInfo">重置</el-button>
        <el-button type="primary" size="small" @click="nextStep">下一步</el-button>
      </el-form-item>
    </el-form>
    <el-divider class="margin" />
    <el-card class="tip-wrapper margin-left margin-right" :body-style="{ padding: 0 }">
