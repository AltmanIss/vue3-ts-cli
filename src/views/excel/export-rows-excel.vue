  ...
  <div class="main-container">
    <TableHeader>
      <template v-slot:right>
        <el-button type="primary" size="mini" @click="exportExcel">导出选中的Excel </el-button>
      </template>
    </TableHeader>
    <TableBody ref="tableBody">
      <template #default>
        <el-table ref="table" :data="dataList" @selection-change="handleSelectionChange">
...
const post = usePost();
const { handleSuccess, dataList, selectRows, handleSelectionChange } = useDataTable();
const tableBody = ref();
