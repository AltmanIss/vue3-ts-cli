<template>
  <div class="editor-wrapper" :style="{ zIndex: zIndex, height: height + 50 + 'px' }">
...
import { defineComponent, onBeforeUnmount, onMounted, ref, toRef, watch } from '@vue/runtime-core';
